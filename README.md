...
<p align="center">
  <img src="https://files.catbox.moe/rqygc3.jpg" alt="Thumbnail" />
</p>
...
await sock.sendMessage(jid, { 
    eventMessage: { 
        isCanceled: false, 
        name: "Hello World", 
        description: "kyzz not dev", 
        location: { 
            degreesLatitude: 0, 
            degreesLongitude: 0, 
            name: "Vanegeta" 
        }, 
        joinLink: "https://call.whatsapp.com/video/aboutkyzzl", 
...
await sock.sendMessage(jid, {
    interactiveMessage: {
        ...
        externalAdReply: {
            ...
            mediaUrl: " X ",
            sourceUrl: "https://t.me/FaaLynxiee",
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/FaaLynxiee",
                    merchant_url: "https://t.me/FaaLynxiee"
                })
            }
        ]
    }
